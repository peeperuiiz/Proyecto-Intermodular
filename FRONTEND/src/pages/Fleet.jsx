  ...
  return (
    ...
    <main>
        ...
        <div className='w-[80%] flex flex-wrap mx-auto justify-center gap-5'>
            ...
            aviones.map((item) => {
                return(
                    <div className='flex flex-col w-[350px] border-2 border-[#0B1F3A] rounded-lg mb-5 pt-4'>
                        <div className='bg-cover bg-center rounded-lg h-[300px] w-[90%] h-[90%] m-auto' style={{ backgroundImage: `url(${item.ruta})` }}></div>
